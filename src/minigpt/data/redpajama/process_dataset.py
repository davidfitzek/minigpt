...
def process_sample(text: str, total_tokens: int, max_tokens: Optional[int], 
                   tokenizer) -> Tuple[str, int, bool]:
    """
...
def save_combined_text(combined_text: str, output_dir: str, encoding: str = "gpt2") -> Dict:
    """
...
def process_redpajama_sample(output_dir: str = "redpajama_sample", 
                             max_tokens: Optional[int] = None,
                             encoding: str = "gpt2") -> Dict:
    """
